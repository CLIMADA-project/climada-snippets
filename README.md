...
## How to use
Anyone is free to use the code shared in this repository. *Note that the code in this repository is not maintained or updated, so you may need to adjust the CLIMADA version you are using or update the code before using it.*
...
* choose a descriptive name for your snippet
* mention CLIMADA Core or Petals version last used to run the code
* consider including your name and contact details as the author of the snippet (not mandatory)

### What belongs here:
* code snippets and functions that facilitate accessing, analysing, and plotting climate risk related data, in ways that can complement the CLIMADA Core [climada_python](https://github.com/CLIMADA-project/climada_python) and Petals [climada_petals](https://github.com/CLIMADA-project/climada_petals) code base
